...
MFRC522 rfid1(SS_PIN1, RST_PIN);   // Create MFRC522 instance.
...
void cardScan1() {
  ...
  for (byte i = 0; i < rfid1.uid.size; i++) 
  {
     ...
     Serial.println(rfid1.uid.uidByte[i], HEX);
...
void cardScan2() {
  ...
  for (byte i = 0; i < rfid2.uid.size; i++) 
  {
     ...
     Serial.println(rfid2.uid.uidByte[i], HEX);
     content1.concat(String(rfid2.uid.uidByte[i] < 0x10 ? " 0" : " "));
     content1.concat(String(rfid2.uid.uidByte[i], HEX));
  }

  
  delay(100);
  content1.toUpperCase();
  if (content1.substring(1) == "20 1C 8B 7C" && card1 == false) //change here the UID of the card/cards that you want to give access
  {
    hue.turnOn(ID,true);
    color += 60000;
    sat += 255;
  ...
  else if (content1.substring(1) == "20 1C 8B 7C" && card1 == true){
    color -= 60000;
    sat -= 255;
    bri -= 255;
    scan--;
  ...
  if (content1.substring(1) == "10 3F 8C 7C" && card2 == false) //change here the UID of the card/cards that you want to give access
  {
    hue.turnOn(ID,true);
    color += 30000;
    sat += 100;
  ...
  else if (content1.substring(1) == "10 3F 8C 7C" && card2 == true) {
    color -= 30000;
    sat -= 100;
    bri -= 50;
    scan--;
  ...
  if (content1.substring(1) == "4B B9 2A 0B" && card3 == false) //change here the UID of the card/cards that you want to give access
  {
    hue.turnOn(ID,true);
    color += 500;
    sat += 200;
  ...
  else if (content1.substring(1) == "4B B9 2A 0B" && card3 == true) {
    color -= 500;
    sat -= 200;
    bri -= 200;
    scan--;
  ...
  if (content1.substring(1) == "04 AB 8B 72 97 3C 80") //change here the UID of the card/cards that you want to give access
  {
    color = 0;
    sat = 0;
    bri = 0;
